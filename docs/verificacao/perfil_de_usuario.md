...
O perfil do usuário delineia, a partir de métodos de pesquisa, os usuários que terão os objetivos apoiados pelo sistema. Esses dados podem ser extraídos com o uso de diversos métodos de avaliação [1].
...
|:-:|:-:|:-:|:-:|:-:|
| 10 | É conduzido um estudo para a coleta de dados para o desenvolvimento do perfil de usuário (e. g. entrevista, questionário) | 1 | 1 | 0 |
| 11 | O perfil de usuário descrito pelo artefato contém as características necessárias para uma boa definição de usuário no geral? | 7 | 5 | 2 |
| 12 | É disponibilizado um termo de consentimento para a realização da pesquisa, demonstrando claramente o destino e uso dos dados? | 1 | 1 | 0 |
| 13 | São utilizadas ao menos duas técnicas para a definição de um perfil de usuário? | 2 | 1 | 1 |
| 14 | Os usuários foram categorizados em grupos com base em suas semelhanças (grupos de idade, tarefas principais no sistema, etc.) | 1 | 0 | 1 |
| 15 | Se utilizado um questionário, o ambiente de uso do software aparece nas questões? (e.g. uso via celular, no trabalho ou em casa, via computador, etc.) | 1 | 0 | 1 |
...
Há erros ortográficos espalhados por todo o artefato. Exemplos podem ser extraídos da introdução, como em "Essa etapa é de extrema importância, pois tem como objetivo melhorar a expêriencia dos usuários que a acessam.", onde há erro de concordância verbal, ou da seção de resultados coletados, onde é visível um erro de digitação em "termo consentimento".

### 5.2 Verificação 4 - As tabelas e imagens possuem legenda padronizada e chamada no texto?

Nenhuma das imagens ou tabelas possuem legendas adequadas ao padrão do projeto ou são chamadas no texto anteriormente ao seu uso.

### 5.3 Verificação 11 - O perfil de usuário descrito pelo artefato contém as características necessárias para uma boa definição de usuário no geral? 

Como definido anteriormente na seção de metodologia, não há menção dos objetivos dos usuários do site do Detran GO ou da experiência dos usuários com computadores além do tempo de uso habitual.

### 5.4 Verificação 13 - São utilizadas ao menos duas técnicas para a definição de um perfil de usuário? 

Não é utilizada nenhuma técnica de priorização de elementos do perfil de usuário.

### 5.5 Verificação 14 - Os usuários foram categorizados em grupos com base em suas semelhanças (grupos de idade, tarefas principais no sistema, etc.)?

Os usuários não são categorizados de nenhuma forma devido à ausência de priorização, não podendo assim definir um usuário médio de maneira consistente ou visualizar os diferentes perfis de usuário que acessam e usam o site do Detran GO.

### 5.6 Se utilizado um questionário, o ambiente de uso do software aparece nas questões? (e.g. uso via celular, no trabalho ou em casa, via computador, etc.)

O ambiente de uso do software é tangencialmente imaginável a partir da questão 5 do questionário aplicado. No entanto, não há menção sobre local de uso, objetivos de uso, privilégios de uso (usuários logados), entre outros.

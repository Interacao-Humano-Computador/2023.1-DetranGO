# Verificação - Planejamento da Avaliação - Protótipo de Alta Fidelidade
...
### 3.4.1 Verificação 1 - O artefato apresenta questões práticas da avaliação?
...
### 3.4.2 Verificação 5 - O artefato explica e detalha como a metodologia vai ser utilizada e aplicada para o planejamento da avaliação?

O artefato não deixou claro a aplicação da metodologia escolhida, na qual é o uso do *framework* DECIDE
### 3.4.3 Verificação 6 - O artefato segue algum modelo de planejamento de avaliação estabelecido?

...
| 14 | O artefato marca a necessidade de organizar os dados encontrados de maneira clara, com gráficos, enumerações empíricas e outros? | 1 | 0 | 1 |
| 15 | O artefato marca a necessidade de uma seção para a interpretação e análise dos dados encontrados de maneira organizada? | 1 | 0 | 1 |
...
![Grau de satisfação planejamento relato resultados storyboard](../assets/analise/storypr/satisfacao%20planejamento%20relato%20storyboard.png)

</center>

<center>
Figura 1: Grau de satisfação do artefato do planejamento do relato dos resultados da avaliação do storyboard (Fonte: Autor, 2023).
</center>

<center>

![Porcentagem erros planejamento relato resultados storyboard](../assets/analise/storypr/erros%20planejamento%20relato%20storyboard.png)

</center>

<center>
Figura 2: Porcentagem de erros do artefato do planejamento do relato dos resultados da avaliação do storyboard (Fonte: Autor, 2023).
</center>
...
### 5.1 Verificação 14 - O artefato marca a necessidade de organizar os dados encontrados de maneira clara, com gráficos, enumerações empíricas e outros?

O presente artefato não possui seção destinada a demarcar a necessidade de organizar os dados extraídos de maneira organizada no relato da avaliação do storyboard.

### 5.2 Verificação 15 - O artefato marca a necessidade de uma seção para a interpretação e análise dos dados encontrados de maneira organizada?

O presente artefato não demarca a necessidade de uma seção para a interpretação e análise dos dados extraídos a partir das entrevistas.
...
| -------- | -------- | --------------------------------------- | -------------- | ------------- |
|  `1.0`   | 18/06/23 | Primeira versão da verificação do planejamento do relato do storyboard | Felipe M. | Pedro M.  |
